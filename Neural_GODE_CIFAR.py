...
parser.add_argument('--spline_n', type=int, default=8)  # number of coefficients 
parser.add_argument('--spline_k', type=int, default=1)  # degree of B-spline
parser.add_argument('--int_T', type=int, default = 1)
parser.add_argument('--ode_step_size', type=float, default=0.05)
parser.add_argument('--num_equations', type=int, default = 64)
